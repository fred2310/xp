    ...
    extends AbstractBuilderFactory
{
    ...
    private QueryBuilder createBooleanFilter( final BooleanFilter booleanFilter )
    {
        ...
        stream( createBooleanFilterChildren( booleanFilter.getMust() ) ).forEach( builder::must );
        stream( createBooleanFilterChildren( booleanFilter.getMustNot() ) ).forEach( builder::mustNot );
        stream( createBooleanFilterChildren( booleanFilter.getShould() ) ).forEach( builder::should );
