...
public class ResolveSyncWorkPerformanceBootstrap
{
    ...
    protected EmbeddedElasticsearchServer server;

    void startClient()
    {
        server = new EmbeddedElasticsearchServer( new File( "C:\\es\\data\\index" ) );
    ...
    void setupServices()
    {
        final BlobStore blobStore = CachedBlobStore.create().
            blobStore( new FileBlobStore( new File( "C:\\es\\data\\blobs" ) ) ).
            build();
